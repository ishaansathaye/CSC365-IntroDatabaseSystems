...
\framebox{
    ...
    \hfill Spring 2023} }
    \vspace{4mm}
    \hbox to 6.28in { {\Large \hfill Lecture 7: Python Connectivity and Relational Algebra \hfill} }
    \vspace{2mm}
    \hbox to 6.28in { {\it Instructor: Alex Dekhtyar \hfill Ishaan Sathaye} }
    }
}
...
These get passed to mysql.connector.connect() function. This returns a connection object.
