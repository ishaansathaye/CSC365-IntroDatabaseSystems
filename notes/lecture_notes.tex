...
\section{\fontsize{17.28}{0} \selectfont Database and DBMS}
...
\framebox{
    ...
    \hfill Spring 2023} }
    \vspace{4mm}
    \hbox to 6.28in { {\Large \hfill Lecture 16: Nested Queries \hfill} }
    \vspace{2mm}
    \hbox to 6.28in { {\it Instructor: Alex Dekhtyar \hfill Ishaan Sathaye} }
    \vspace{2mm}}
}
...
\framebox{
    ...
    \hfill Spring 2023} }
    \vspace{4mm}
    \hbox to 6.28in { {\Large \hfill Lecture 17: Difference, Joins, and 
    Additional SQL Syntax \hfill} }
    \vspace{2mm}
    \hbox to 6.28in { {\it Instructor: Alex Dekhtyar \hfill Ishaan Sathaye} }
    \vspace{2mm}}
}
